...
import {
  ...
  Calendar, DollarSign, Trash2, ChevronDown,
  AlertTriangle, Clock,
} from "lucide-react";
...
function CreateProjectModal({
  ...
  const {
    ...
    // defaultValues: { currency: "USD", status: "planning" },
    defaultValues: {
      name: "",
      clientId: "",
      description: "",
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input type="text" placeholder="E-commerce Redesign" {...register("name")} className={inputCls(!!errors.name)} />
          ...
          <div className="space-y-1.5">
            ...
            <textarea rows={2} placeholder="What does this project involve?" {...register("description")} className={cn(inputCls(), "resize-none")} />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <input type="number" min="0" step="100" placeholder="5000" {...register("budget")} className={inputCls(!!errors.budget)} />
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <input type="date" {...register("deadline")} className={inputCls()} min={new Date().toISOString().split("T")[0]} />
            </div>
          </div>

          <div className="flex gap-3 pt-1">
            <button type="button" onClick={onClose} className="flex-1 py-2.5 rounded-xl text-sm font-medium border border-border hover:bg-muted transition-colors">
              Cancel
            </button>
            <button
              type="submit"
      ...
      <div className="space-y-6 p-6 animate-fade-up">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-brand hover:bg-brand/90 text-white text-sm font-semibold px-4 py-2 rounded-xl transition-colors flex-shrink-0"
          >
